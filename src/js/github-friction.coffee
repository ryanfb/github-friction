...
build_github_friction = ->
  ...
  if get_cookie 'access_token'
    ...
    fork_button.append('<iframe src="http://ghbtns.com/github-btn.html?user=ryanfb&repo=github-friction&type=fork&size=large" allowtransparency="true" frameborder="0" scrolling="0" width="78" height="30"></iframe>')
